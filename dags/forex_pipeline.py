...
with DAG('forex_pipeline', default_args=default_args, schedule_interval=timedelta(hours=2), catchup=False) as dag:
    ...
    is_api_available = HttpSensor(
        ...
        endpoint=current_date+'?apikey=BMRBUBjKNZ2B3Mn1B7YJJ9wv0o8kTtoX',
